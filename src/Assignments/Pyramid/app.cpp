...
void SimpleShapeApplication::init() {
    ...
    glm::mat4 View = glm::lookAt(
        glm::vec3(0.0, 0.0, 2.0), // Camera coordinates in World Space
        glm::vec3(0.0, 0.0, 1.0), // "looks at" the origin
        glm::vec3(0.0, 1.0, 0.0)  // Head is up (set to 0,-1,0 to look upside-down) -> from OpenGL Documentations
    );
    // Model | Matrix
